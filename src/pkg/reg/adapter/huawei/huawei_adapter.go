...
func (a *adapter) ListNamespaces(query *model.NamespaceQuery) ([]*model.Namespace, error) {
	...
	r, err := http.NewRequest("GET", urls, nil) //nolint:noctx // TODO: Add context support
	if err != nil {
...
func (a *adapter) PrepareForPush(resources []*model.Resource) error {
	...
	for namespace := range namespaces {
		...
		r, err := http.NewRequest("POST", url, strings.NewReader(string(namespacebyte))) //nolint:noctx // TODO: Add context support
		if err != nil {
			return err
		}
