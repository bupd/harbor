...
![Click on Configuration](./img/fedidp-enterprise-1.png)

### Step 2: Click on Enterprise

Click the **Enterprise** tab.

![Click on Enterprise](./img/fedidp-enterprise-2.png)

### Step 3: Enable Identity Providers for Projects

Click the checkbox next to **Enable Identity Providers for Projects**.

![Enable checkbox](./img/fedidp-enterprise-3.png)

### Step 4: Click SAVE

Click **SAVE** to apply the configuration.

![Click SAVE](./img/fedidp-enterprise-4.png)

### Step 5: Confirm Success

A success message confirms the configuration was saved.

![Success message](./img/fedidp-enterprise-5.png)
...
> - **Issuer uniqueness**: Once a project creates an IdP with an issuer URL, other projects cannot create IdPs with the same issuer
